...
g++ -fpermissive -std=c++0x -std=c++11 -std=gnu++0x -ggdb -I include -I include-epc -I /home/sgw/Downloads/MTP/netmap-master/sys -std=c++11 -o kby_mme.o  -c kby_mme.cpp  
...
#g++ -fpermissive -std=c++0x -std=c++11 -std=gnu++0x -ggdb -o mtcp_hss packet.o utils.o s1ap.o gtp.o mysql.o diameter.o sip.o uecontext.o telecom.o  security.o mtcp_hss.o  mtcp_lib.o -lcrypto -pthread `mysql_config --cflags --libs`
g++ -fpermissive -std=c++0x -std=c++11 -std=gnu++0x -ggdb -o kby_mme include-epc/packet.o include-epc/utils.o include-epc/s1ap.o include-epc/gtp.o include-epc/mysql.o include-epc/diameter.o include-epc/telecom.o  include-epc/security.o kby_mme.o  mtcp_lib.o -lcrypto -pthread `mysql_config --cflags --libs`
